 ...
 * MIT License
 *
 * @brief Makes Serial debug output task-safe and removable from production builds.
 * @note Calls keep the familiar Arduino print style and compile to no-ops when
...
namespace utils::debug_io
{
    ...
    /**
     * @brief Scope-based lock that keeps a block of Serial output together.
