...
/**
 * @brief High-level owner of the current drive command.
 * @note Used by PowerDriveHandler to apply safe handover rules when movement
 *       authority changes between local car controls, RC and future joystick control.
 */
