 ...
 * MIT License
 *
 * @brief Serial debug helpers for decoded configuration snapshots.
 * @note Observes ConfigBus and prints decoded DIP/shifter state only.
 *       Configuration logic remains in ConfigPublisher.
 *
 * @file ConfigDebug.h
...
namespace utils::config_debug
{
     ...
     * @return const char* Static string representing the mode.
     */
     ...
     * @return const char* Static string representing the gear.
     */
     ...
     * @return true Reverse contact is active.
     * @return false Reverse contact is inactive.
     */
     ...
     *
     * @param gear_raw Physical shifter contact bitfield from ConfigSnapshot.
     * @return true Forward/Drive contact is active.
     * @return false Forward/Drive contact is inactive.
     */
     ...
     *
     * @param gear_raw Physical shifter contact bitfield from ConfigSnapshot.
     * @return true D1 modifier contact is active.
     * @return false D1 modifier contact is inactive.
     */
     ...
     *
     * @param gear_raw Physical shifter contact bitfield from ConfigSnapshot.
     * @return true D3 modifier contact is active.
     * @return false D3 modifier contact is inactive.
     */
    ...
    /**
     * @brief Test whether two configuration snapshots differ in meaningful fields.
     ...
     *
     * @return true The snapshots differ in decoded mode, decoded gear, raw DIP,
     *              raw gear contacts, or DIP lock state.
     * @return false The meaningful configuration fields are the same.
     */
    ...
    /**
     * @brief Print one configuration snapshot in a human-readable format.
     *
