 ...
 * @note Provides one shared cached view of MCP23017 state so publishers do not duplicate it.
 *
 * @file McpView.h
...
namespace hal
{
    ...
    public:
        ...
        /// @brief Refresh cached snapshot (single best-effort peek).
        ...
        /// @brief True if the cached sample is valid (e.g., MCP read succeeded).
